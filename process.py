...
def run_caffe(src):
    ...
    if net is None:
        ...
        net = caffe.Net("D:/AI/tests/deploy.prototxt", "D:/AI/tests/hed_pretrained_bsds.caffemodel", caffe.TEST)
...
def edges(src):
    ...
    with tempfile.NamedTemporaryFile(suffix=".png", delete=False) as png_file, \
            tempfile.NamedTemporaryFile(suffix=".mat", delete=False) as mat_file:
